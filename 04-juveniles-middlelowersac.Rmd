...
```{r knights-timing-fig, fig.cap = "Knights Landing Timing"}
...
# knitr::include_graphics(knights_link)
```

```{r sactrawl-timing-fig, fig.cap = "Sac Trawl Timing"}
...
# knitr::include_graphics(sactrawl_link)
```
