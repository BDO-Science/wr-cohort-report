...
```{r HMCWLKVONflow-fig, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = paste("Hamilton City (HMC), Wilkins Slough (WLK) and Verona (VON) Average Flows (cfs) in",report_year, "and over the 10-year average"), fig.width = 8, fig.height = 7}
...
```{r HMCWLKVONflow-tab, echo = FALSE, message = FALSE, warning = FALSE, tab.cap = paste("Hamilton City (HMC), Wilkins Slough (WLK) and Verona (VON) Mean, Maximum and Minimum Flows (cfs) in", report_year, "-", report_year+1)}
...
```{r RDBFPTDO-fig, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = paste0("Turbidity at Red Bluff Diversion Dam (RDB) and Sacramento River at Freeport (FPT) from September ", report_year, "through March ", report_year + 1)}
...
```{r RDBFPTTurb-tab, echo = FALSE, message = FALSE, warning = FALSE, tab.cap = paste("RDB (Red Bluff Diversion Dam) and Sacramento River at Freeport (FPT) Mean, Maximum, Minimum Monthly Flows (cfs) in", report_year, "-", report_year+1)}
...
```{r WLKwtemp-tab, echo = FALSE, message = FALSE, warning = FALSE, tab.cap = paste("WLK (Sacramento River Below Wilkins Slough) Mean, Maximum, Minimum Monthly Water Temperature (°F) in", report_year, "-", report_year+1)}
...
```{r RBDSRHDO-tab, echo = FALSE, message = FALSE, warning = FALSE, tab.cap = paste("RBD (Red Bluff Diversion Dam) and Sacramento River at Hood (SRH) Mean, Maximum, Minimum Monthly Flows (cfs) in", report_year, "-", report_year+1)}
