...
\chapter{Spawning Adults}\label{spawning-adults}}
...
2021 was a \textbf{Critical} water year type and 2020 was a \textbf{Dry} water year type.
...
\caption{\label{fig:historicalwtemp-fig}Daily Average Water Temperature at Sacramento River at Clear Creek (CCR) and Sacramento River at Balls Ferry Bridge (BSF) in 2021 and over the 10-year average}
\end{figure}
...
\caption{\label{fig:cohortreplacement-fig}Cohort Replacement Rate. Current year female spawners are divided by number of female spawners from 3 years ago. Horizontal line is at 1.0.}
\end{figure}
...
\item
  ...
  \end{itemize}
\item
  Peak spawning week: July 11 (Week 29)
  ‒ 10-Year median:
  ‒ 20-Year median:
\end{itemize}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/redds-fig-1.pdf}
\caption{\label{fig:redds-fig}Redd Counts by Year. Dashed line indicates average from 2013 to 2021}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/KRDDatemp-fig-1.pdf}
\caption{\label{fig:KRDDatemp-fig}Daily Air Temperature (deg F) at Redding Municipal Airport from May 2021 through November 2021 and maximum and minimum temperatures since 2003}
\end{figure}
...
\item
  ...
  \end{itemize}
\item
  \textbf{Egg to Fry Survival (ETF Survival; JPI-based):} ETF Survival in 2021 was below the 10-year average ETF and below the 20-year average ETF (Figure \ref{fig:ETFSurv-fig}).

  \begin{itemize}
  \tightlist
  \item
    \textbf{10-year average:} 18.3\%
  \item
    \textbf{20-year average:} 22.3\%
  \end{itemize}
\end{itemize}
...
The SacPAS Fish Model was developed by the University of Washington Columbia Basin Research center. The model, along with additional method and usage details, are available on: \href{https://www.cbr.washington.edu/sacramento/fishmodel/}{``the SacPAS website''}.
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/wtempBND-fig-1.pdf}
\caption{\label{fig:wtempBND-fig}Daily Water Temperature (degF) at Sacramento River at Bend (BND) in 2021 and 10-year average between July and December.}
\end{figure}
...
Fry abundance (JPI) is calculated by Red Bluff USFWS by calculating the sum of:
- fry passage from rotary screw trap data, and
- estimated smolts and pre-smolts that pass RBDD, which are converted to fry-equivalents by applying the inverse of the fry-to-smolt survival rate (new method used as of BY2019; Voss and Poytress 2022).
...
\item
  ...
  \tightlist
  \item
    \textbf{10-year average:}
  \item
    \textbf{20-year average:}
  \end{itemize}
\item
  Fry-equivalent JPI:
...
\hypertarget{telemetry-studies}{%
\subsection{Telemetry Studies}\label{telemetry-studies}}

Include a subset of the data

Table of telemetry release groups
Reach-specific survival to below RBDD
...
\tightlist
\item
  \textbf{Average daily fork length}
  ...
  \end{itemize}
\item
  74 \% of fish migrated past RBDD as fry (\textless46 mm FL)
\item
...
\caption{\label{fig:rbdd-fl-fig}Fork Length Distribution in 2021 and 10-year average at RBDD RST. The yellow line at 45 mm indicates the length transition from fry to smolt.}
\end{figure}
...
\caption{\label{fig:HMCWLKVONflow-fig}Daily Flows (cfs) at Sacramento River at Hamilton City (HMC), Sacramento River at Wilkins Slough (WLK) and Sacramento River at Verona (VON) from September 2021 through March 2022 and over the 10-year average}
\end{figure}
...
\caption{\label{fig:FPTflow-fig}Freeport (FPT) Average Flows (cfs) in 2021 and over the 10-year average}
\end{figure}

\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/DTOflow-fig-1.pdf}
\caption{\label{fig:DTOflow-fig}Delta Outflow (DTO) in 2021 and over the 10-year average}
\end{figure}

\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/OMRflow-fig-1.pdf}
\caption{\label{fig:OMRflow-fig}OMR Flow (OMR) (cfs) in 2021 and over the 10-year average}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/hatcherysurvival-fig-1.pdf}
\caption{\label{fig:hatcherysurvival-fig}Cumulative Survival by River Kilometer}
\end{figure}
...
\hypertarget{adults}{%
\subsection{Adults}\label{adults}}
