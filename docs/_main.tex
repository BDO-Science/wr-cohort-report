...
We summarize environmental and habitat conditions in 2021 and assess the 2021 brood year of Sacramento winter-run Chinook salmon (WRCS; \emph{Oncorhynchus tshawytscha}) (\textbf{BY 2021}). We used data available online to generate this report. This report follows the format of the BY 2019 WRCS Report written by Anchor QEA (\citet{ref}(\url{https://www.anchorqea.com/news/brood-year-2019-winter-run-chinook-salmon-operations-and-monitoring-assessment/})). The assessment was in collaboration with the \texttt{Sacramento\ River\ Science\ Partnership}.
...
\hypertarget{wr-cohort-report}{%
\chapter{WR Cohort Report}\label{wr-cohort-report}}

This is the WR Cohort Report for 2021

\hypertarget{here-is-the-info-you-will-see}{%
\section{Here is the info you will see}\label{here-is-the-info-you-will-see}}
...
\chapter{Environmental Drivers}\label{environmental-drivers}}

\hypertarget{wq}{%
\section{Water Quality}\label{wq}}
...
\caption{\label{fig:KWKflow-fig}Flows at Keswick (KWK), 2019-2022.}
\end{figure}

\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/DOTurb-fig-1.pdf}
\caption{\label{fig:DOTurb-fig}Dissolved Oxygen and Turbidity at Keswick Dam (KWK) and Sacramento River upstream from Confluence with Clear Creek (CCR).}
\end{figure}
...
\hypertarget{biological-responses}{%
\chapter{Biological Responses}\label{biological-responses}}

\hypertarget{spawners}{%
\section{Spawners}\label{spawners}}
